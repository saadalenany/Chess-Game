...
public class Knight implements Piece {
    ...
    ArrayList<String> Knightavailable = new ArrayList<>();

    //note that the String size will always be 3 if the place in Knight's range & no one else's ,format like this "1,2" means piece is hovered
    //in special case if the place in knight's range is also in the range of any whiteside piece the String size will be 4 ,format like this "1,2="
